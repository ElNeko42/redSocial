    ...
    <div
        ...
        <header class="flex flex-start">
            <div>
                <a href="#"
                    ...
                    <img src="https://images.pexels.com/photos/3460478/pexels-photo-3460478.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
        ...
        <div class="px-6 pt-4 pb-3">
            <div class="flex items-start">
                <input class="w-full resize-none outline-none appearance-none" aria-label="Agrega un comentario..."
