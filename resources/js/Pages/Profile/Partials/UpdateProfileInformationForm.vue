    ...
    <FormSection @submitted="updateProfileInformation">
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <TextInput id="web_site" v-model="form.web_site" type="text" class="mt-1 block w-full" />
                <InputError :message="form.errors.web_site" class="mt-2" />
            </div>
            <!-- Presentation-->
            <div class="col-span-6 sm:col-span-4">
                <InputLabel for="presentation" value="Presentation" />
                <TextInput id="presentation" v-model="form.presentation" type="text" class="mt-1 block w-full" />
